...
class EmpleadosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create empleado" do
    assert_difference('Empleado.count') do
      post empleados_url, params: { empleado: { nombre: @empleado.nombre, puesto: @empleado.puesto, rfc: @empleado.rfc, sucursales_id: @empleado.sucursales_id } }
    end
  ...
  test "should update empleado" do
    patch empleado_url(@empleado), params: { empleado: { nombre: @empleado.nombre, puesto: @empleado.puesto, rfc: @empleado.rfc, sucursales_id: @empleado.sucursales_id } }
